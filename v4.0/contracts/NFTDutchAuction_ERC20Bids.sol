...
contract NFTDutchAuction_ERC20Bids is ERC721, UUPSUpgradeable {
...
function createAuction(uint _tokenId) public onlyOwner isUpgradeable {
...
function bid(uint _tokenId, uint256 _bidAmount) public isUpgradeable {
...
function cancelAuction(uint _tokenId) public onlyOwner isUpgradeable {
    require(tokenIdToAuctionEnd[_tokenId] > 0, "NFTDutchAuction: Token is not on auction");
    tokenIdToAuctionEnd[_tokenId] = 0;
    tokenIdToPrice[_tokenId] = 0;
