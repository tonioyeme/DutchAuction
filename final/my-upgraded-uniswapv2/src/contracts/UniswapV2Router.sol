...
//     require(token != WETH, 'UniswapV2Router: INVALID_TOKEN');
...
//         amountETHMin
//     );
//     require(amountToken > 0 && amountETH > 0, 'UniswapV2Router: INSUFFICIENT_OUTPUT_AMOUNT');
...
//     // emit event
//     emit addLiquidityETH(msg.sender, amountToken, amountETH, liquidity);
// }
    // **** REMOVE LIQUIDITY ****
    ...
    require(amountA >= amountAMin && amountB >= amountBMin, 'UniswapV2Router: INSUFFICIENT_AMOUNT');
}
...
function removeLiquidityETHWithPermit(
    ...
    IUniswapV2Pair pair = IUniswapV2Pair(UniswapV2Library.pairFor(factory, token, WETH));
}
